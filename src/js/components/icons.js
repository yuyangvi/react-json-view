...
export class Clippy extends React.Component {
    render() {
        ...
        return (
            ...
            >
            <g>
                <path d="M12,3V1a1,1,0,0,0-1-1H1A1,1,0,0,0,0,1V11a1,1,0,0,0,1,1H3V11H1V1H11V3Z" />
                <path d="M5,5V15H15V5ZM5,4H15a1,1,0,0,1,1,1V15a1,1,0,0,1-1,1H5a1,1,0,0,1-1-1V5A1,1,0,0,1,5,4Z" />
			    <rect x="9.5" y="6" width="1" height="8"/>
			    <rect x="9.5" y="6" width="1" height="8" transform="translate(20) rotate(90)"/>
            </g>
            </svg>
            </span>
        );
